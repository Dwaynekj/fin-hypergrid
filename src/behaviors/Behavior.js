...
var Behavior = Base.extend('Behavior', {
     ...
     */
    reindex: function() {
        return this.deprecated('reindex()', null, '2.1.0', arguments, 'No Longer Supported');
    },
    ...
    getUnfilteredValue: function() {
        return this.deprecated(' getUnfilteredValue:()', null, '2.1.0', arguments, 'No Longer Supported');
    },
    ...
    getController: function(type) {
        return this.deprecated('getController()', '', '2.1.0', arguments, 'No Longer Supported');
    },
    ...
    setController: function(typeOrHashOfTypes, controller) {
        return this.deprecated('setController()', '', '2.1.0', arguments, 'No Longer Supported');
    },
    /**
     * @memberOf Behavior#
     * @deprecated
    ...
    prop: function(type, columnIndex, keyOrHash, value) {
        return this.deprecated('prop()', '', '2.1.0', arguments, 'No Longer Supported');
    },
    /**
     * @memberOf Behavior#
     * @deprecated
     */
    get charMap() {
        return this.deprecated('charMap()', '', '2.1.0', arguments, 'No Longer Supported');
    },
    ...
    getFilteredData: function() {
        return this.deprecated('getIndexedData()', '', '2.1.0', arguments, 'No Longer Supported');
    },
    /**
     * @memberOf Behavior#
     * @deprecated
